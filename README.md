The images file contain the possible image combinations required to run the game with the blank being the default and the white being the response for a correct match.
